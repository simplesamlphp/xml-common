...
use SimpleSAML\XMLSchema\Type\{AnyURIValue, IDValue, NCNameValue, StringValue};
...
use SimpleSAML\XMLSchema\XML\Notation;
...
final class NotationTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 3) . '/resources/xml/xs/notation.xml',
        );
    }
