...
use SimpleSAML\XMLSchema\Type\{AnyURIValue, IDValue, NCNameValue, StringValue, QNameValue};
use SimpleSAML\XMLSchema\Type\Schema\SimpleDerivationSetValue;
use SimpleSAML\XMLSchema\XML\AbstractAnnotated;
use SimpleSAML\XMLSchema\XML\AbstractTopLevelSimpleType;
use SimpleSAML\XMLSchema\XML\AbstractOpenAttrs;
use SimpleSAML\XMLSchema\XML\AbstractSimpleType;
...
final class TopLevelSimpleTypeTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 3) . '/resources/xml/xs/topLevelSimpleType.xml',
        );
    }
