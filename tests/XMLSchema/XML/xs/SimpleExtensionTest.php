...
use SimpleSAML\XMLSchema\XML\xs\AbstractSimpleExtensionType;
use SimpleSAML\XMLSchema\XML\xs\AbstractExtensionType;
...
final class SimpleExtensionTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/xs/simpleExtension.xml',
        );
    }
