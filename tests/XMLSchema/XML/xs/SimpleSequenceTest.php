...
use SimpleSAML\XMLSchema\Type\Builtin\{AnyURIValue, IDValue, NCNameValue, StringValue, QNameValue};
...
use SimpleSAML\XMLSchema\XML\xs\AbstractExplicitGroup;
use SimpleSAML\XMLSchema\XML\xs\AbstractOpenAttrs;
use SimpleSAML\XMLSchema\XML\xs\AbstractSimpleExplicitGroup;
...
use SimpleSAML\XMLSchema\XML\xs\SimpleSequence;
...
final class SimpleSequenceTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/xs/simpleSequence.xml',
        );
    }
