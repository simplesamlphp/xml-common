...
use SimpleSAML\XMLSchema\XML\xs\AbstractTopLevelSimpleType;
use SimpleSAML\XMLSchema\XML\xs\AbstractOpenAttrs;
use SimpleSAML\XMLSchema\XML\xs\AbstractSimpleType;
...
final class TopLevelSimpleTypeTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/xs/topLevelSimpleType.xml',
        );
    }
