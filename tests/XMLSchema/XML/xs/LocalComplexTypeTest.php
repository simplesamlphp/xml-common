...
use SimpleSAML\XMLSchema\Type\{DerivationSetValue, NamespaceListValue, ProcessContentsValue, WhiteSpaceValue};
use SimpleSAML\XMLSchema\XML\xs\AbstractAnnotated;
use SimpleSAML\XMLSchema\XML\xs\AbstractComplexType;
use SimpleSAML\XMLSchema\XML\xs\AbstractOpenAttrs;
use SimpleSAML\XMLSchema\XML\xs\AbstractLocalComplexType;
...
use SimpleSAML\XMLSchema\XML\xs\LocalComplexType;
...
final class LocalComplexTypeTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/xs/localComplexType.xml',
        );
    }
