...
use SimpleSAML\XMLSchema\Type\{AnyURIValue, BooleanValue, IDValue, NCNameValue, StringValue, QNameValue};
use SimpleSAML\XMLSchema\Type\Schema\{BlockSetValue, DerivationSetValue, FormChoiceValue};
...
use SimpleSAML\XMLSchema\XML\AbstractTopLevelElement;
...
final class TopLevelElementTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 3) . '/resources/xml/xs/topLevelElement.xml',
        );
    }
