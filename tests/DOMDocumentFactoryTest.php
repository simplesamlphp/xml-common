...
final class DOMDocumentFactoryTest extends TestCase
{
    ...
    {
        $this->expectException(RuntimeException::class);
        DOMDocumentFactory::fromFile(self::FRAMEWORK . '/xml/domdocument_invalid_xml.xml');
    }
    ...
    {
        $file = self::FRAMEWORK . '/xml/domdocument_valid_xml.xml';
    ...
    {
        $file = self::FRAMEWORK . '/xml/domdocument_doctype.xml';
        $this->expectException(RuntimeException::class);
    ...
    {
        $file = self::FRAMEWORK . '/xml/domdocument_empty.xml';
        $this->expectException(RuntimeException::class);
